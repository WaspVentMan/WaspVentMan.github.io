...
function whereAmI(PY, PX, clean) {
    ...
    if (clean) {
        ...
        tileInfo.textContent = `solid: ${gridData[PY - 1][PX - 1].solid}`
    }
}
...
window.addEventListener('keydown', function (e) {
    if (e.key == " ") {
        ...
        gridData[PY - 1][PX - 1].solid = !gridData[PY - 1][PX - 1].solid
    } else if (e.key == "'") {
        gridData[PY - 1][PX - 1].water = !gridData[PY - 1][PX - 1].water
    ...
    tileInfo.textContent = `solid: ${gridData[PY - 1][PX - 1].solid}, water: ${gridData[PY - 1][PX - 1].water}`
